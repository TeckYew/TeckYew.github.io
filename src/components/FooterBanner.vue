<template>
  <footer @mouseenter="showGame = true" @mouseleave="showGame = false" style="position: relative;">
    ...
    <!-- Dinosaur Game -->
    <div v-if="showGame" style="padding: 30px 20px; background: var(--game-bg, #f0f0f0); border-top: 2px solid #28a745; cursor: pointer;">
      <div style="max-width: 800px; margin: 0 auto; text-align: center;">
        ...
        <canvas 
          ref="gameCanvas" 
          style="display: block; margin: 0 auto; border: 1px solid var(--game-border, #ddd); background: white; max-width: 100%; height: auto;"
    ...
    <div v-else style="padding: 20px; text-align: center; cursor: pointer;">
      <p style="color: var(--footer-text, #999); font-size: 0.9rem; margin: 0;">
