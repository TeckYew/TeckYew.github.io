export const projects = [
  {
    id: 'handsup',
    category: 'Interaction Design & Prototyping',
    title: 'HandsUP - Interaction Design and Prototyping Project',
    duration: '~12 weeks',
    role: 'UX Designer (Research, Interaction Design, Prototyping)',
    team: '4 members',
    tools: ['Figma', 'User Research', 'Prototyping', 'Usability Testing', 'Design Thinking'],
  ...
  },
  {
    ...
    title: 'Project Management Experience Hackathon',
    duration: '48-hour Hackathon',
    role: 'Project Lead / Strategy & Coordination',
    team: '4 members',
    tools: ['Canva', 'Strategic Design', 'Project Management', 'System Thinking', 'Stakeholder Analysis'],
  ...
  {
    id: 'gis-solar',
    category: 'GIS & Urban Planning Analysis',
    title: 'Geographical Information Systems-based Multi-criteria Analysis for Urban Planning',
    duration: '~12 weeks',
    role: 'Spatial Analysis & Systems Strategy Lead',
    team: '3 members',
    tools: ['ArcGIS', 'QGIS', 'Spatial Analysis', 'Data Visualization', 'Multi-criteria Analysis', 'R'],
  ...
  },
  {
    ...
    role: 'UX Designer (Research, Interaction Design, Prototyping)',
    team: '2 members',
    tools: ['Figma', 'Accessibility Testing', 'Screen Readers', 'User Research', 'Interaction Design'],
